...
class AttNCFDataset(Dataset):
	def __init__(self, dataset, dimension, is_training):
		...
		for i in range(len(self.data)):
			user_feature_col.append(self.user_feature[self.data['user'][i]])
			item_feature_col.append(self.item_feature[self.data['item'][i]])
